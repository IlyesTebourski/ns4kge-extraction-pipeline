"""Anthropic Claude pipeline: markdown article to JSON and per-article TTL."""
...
def run(
    ...
    print(f"\n=== [Claude] Pipeline for {md_path} (slug: {slug}) ===\n")
...
def _build_context(json1: dict, md_tables: str) -> str:
    return (
        ...
        "(e.g. 'PNS' for 'Probabilistic Negative Sampling'). "
